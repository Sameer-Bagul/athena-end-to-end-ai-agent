...
export interface ModelDefinition {
    id: string;
    category: 'intelligence' | 'presence';
    files: ModelFile[];
}

export const NON_OLLAMA_MODELS: Record<string, ModelDefinition> = {
    "tiny.en": {
        id: "tiny.en",
...
export function getLocalModelDir(category: string, modelId: string): string {
