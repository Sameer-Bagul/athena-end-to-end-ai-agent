 ...
 */
export const weatherTool = tool(async ({ city }) => {
 ...
 */
export const clockTool = tool(async ({ timezone }) => {
 ...
 */
export const knowledgeSearchTool = tool(async ({ query }) => {
 ...
 */
export const timerTool = tool(async ({ seconds, label }) => {
